...
import { ClaudeCodeWorkspaceOffer, type WorkspaceChoice } from "./ClaudeCodeWorkspaceOffer";
        ...
        <>
          ...
          {result.recommendations.length > 0 && (
            <section className="section recommendations-section">
              ...
              <p className="open-questions-form__hint">
                No son obligaciones: son sugerencias, tú decides si aplicarlas.
              </p>
              <ul>
          ...
          {result.claude_code && (
            <section className="section claude-code-section">
              ...
              <ListSection
                title="Instrucciones persistentes a mantener"
                items={result.claude_code.persistent_instructions}
              />
              <p>
